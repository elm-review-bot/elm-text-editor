...
var $author$project$DemoSimple$Jabberwock = {$: 'Jabberwock'};
...
var $jxxcarlson$elm_text_editor$Editor$smallConfig = function (c) {
	return {height: c.height, lineHeight: c.lineHeight, showInfoPanel: c.showInfoPanel, width: c.width, wrapOption: c.wrapOption, wrapParams: c.wrapParams};
};
		...
		return $jxxcarlson$elm_text_editor$Editor$Editor(
			{
				...
				state: {
					canReplace: false,
					clipboard: '',
					config: $jxxcarlson$elm_text_editor$Editor$smallConfig(editorConfig),
...
var $author$project$DemoSimple$init = function (_v0) {
	return _Utils_Tuple2(
		{
			clipboard: '',
			document: $author$project$DemoSimple$Jabberwock,
			editor: A2($jxxcarlson$elm_text_editor$Editor$init, $author$project$DemoSimple$config, $author$project$AppText$jabberwocky)
		},
...
var $author$project$DemoSimple$Gettysburg = {$: 'Gettysburg'};
var $author$project$DemoSimple$LongLines = {$: 'LongLines'};
...
var $jxxcarlson$elm_text_editor$Editor$Search$indexedFilterMap = F2(
...
var $jxxcarlson$elm_text_editor$Editor$Search$matches = F2(
	function (key, str) {
		return A2(
			$elm$core$List$filter,
			function (word) {
...
var $jxxcarlson$elm_text_editor$Editor$Search$stringIndices = F2(
	function (key, source) {
...
var $jxxcarlson$elm_text_editor$Editor$Search$positions = function (_v0) {
	var line = _v0.a;
	var source = _v0.b;
	var hits = _v0.c;
	return A2(
		...
		function (_v1) {
			...
			var end = _v1.b;
			return _Utils_Tuple2(
				A2($jxxcarlson$elm_text_editor$Position$Position, line, start),
				A2($jxxcarlson$elm_text_editor$Position$Position, line, end));
		},
		$elm$core$List$concat(
			A2(
				$elm$core$List$map,
				function (hit) {
					return A2($jxxcarlson$elm_text_editor$Editor$Search$stringIndices, hit, source);
				},
				hits)));
};
var $jxxcarlson$elm_text_editor$Editor$Search$searchHits = F2(
	function (key, lines_) {
		...
		return $elm$core$List$concat(
			A2(
				$elm$core$List$map,
				$jxxcarlson$elm_text_editor$Editor$Search$positions,
				A2(
					$elm$core$List$map,
					function (_v0) {
						var idx = _v0.a;
						...
						return _Utils_Tuple3(
							idx,
							str,
							A2($jxxcarlson$elm_text_editor$Editor$Search$matches, key_, str));
					},
					A2(
						$jxxcarlson$elm_text_editor$Editor$Search$indexedFilterMap,
						F2(
							function (i, line) {
...
var $jxxcarlson$elm_text_editor$Editor$Wrap$classifyLine = function (str) {
	...
	return (prefix === '') ? $jxxcarlson$elm_text_editor$Editor$Wrap$Blank : ((A2($elm$core$String$left, 3, prefix) === '```') ? $jxxcarlson$elm_text_editor$Editor$Wrap$CodeDelimiter : ((A2($elm$core$String$left, 2, prefix) === '$$') ? $jxxcarlson$elm_text_editor$Editor$Wrap$CodeDelimiter : $jxxcarlson$elm_text_editor$Editor$Wrap$Text));
};
...
var $jxxcarlson$elm_text_editor$Editor$Wrap$wrapParagraph = F2(
	function (config, _v0) {
		...
		var str = _v0.b;
		if (paragraphType.$ === 'TextParagraph') {
			return A2(
				$elm$core$String$join,
				'\n',
				A2($folkertdev$elm_paragraph$Paragraph$lines, config.wrapParams, str));
		} else {
			return str;
		}
	});
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					$jxxcarlson$elm_text_editor$Editor$Wrap$wrapParagraph(config),
...
var $jxxcarlson$elm_text_editor$Editor$load = F3(
	function (wrapOption, content, editor) {
		...
		var buffer = (_Utils_eq(wrapOption, $jxxcarlson$elm_text_editor$Editor$Config$DoWrap) && (_Utils_cmp(maxLineLength, config.wrapParams.maximumWidth) > 0)) ? $jxxcarlson$elm_text_editor$Buffer$fromString(
			A2($jxxcarlson$elm_text_editor$Editor$Wrap$paragraphs, config, content)) : $jxxcarlson$elm_text_editor$Buffer$fromString(content);
			...
			if (_v0.$ === 'Just') {
				...
				if (_Utils_cmp(
					...
					if (direction.$ === 'Forward') {
						return _Utils_eq(
							position.line,
							$elm$core$Array$length(lines_) - 1) ? A2(
							$jxxcarlson$elm_text_editor$Position$Position,
							position.line,
							$elm$core$String$length(line) - 1) : A2($jxxcarlson$elm_text_editor$Position$Position, position.line + 1, 0);
					} else {
						return A2(
							$jxxcarlson$elm_text_editor$Position$Position,
							position.line,
...
var $jxxcarlson$elm_text_editor$Editor$Update$debounceConfig = {
	strategy: $jinjor$elm_debounce$Debounce$later(100),
...
var $jxxcarlson$elm_text_editor$Editor$Update$jumpToHeight = function (y) {
	return A2(
		$elm$core$Task$attempt,
		function (_v0) {
			return $jxxcarlson$elm_text_editor$Editor$Update$NoOp;
...
var $jxxcarlson$elm_text_editor$Editor$Update$setEditorViewportForLine = function (lineNumber) {
	var y = lineNumber * 16.0;
	var _v0 = y >= 0;
	if (_v0) {
		return A2(
			$elm$core$Task$attempt,
	...
	function (state, buffer) {
		...
		if (_v0.$ === 'Nothing') {
			...
			return _Utils_Tuple3(
				...
				buffer,
				$jxxcarlson$elm_text_editor$Editor$Update$setEditorViewportForLine(cursor.line));
		}
	});
		...
		switch (msg.$) {
			...
			case 'CursorLeft':
				...
				var cmd = function () {
					...
					if (_v2) {
						return $jxxcarlson$elm_text_editor$Editor$Update$setEditorViewportForLine(newCursor.line);
					} else {
						return $elm$core$Platform$Cmd$none;
					}
				}();
				return _Utils_Tuple3(
					...
					buffer,
					$jxxcarlson$elm_text_editor$Editor$Update$setEditorViewportForLine(newCursor.line));
			case 'CursorRight':
				var newCursor = function () {
					var moveFrom = function () {
				...
				var cmd = function () {
					var _v4 = !_Utils_eq(state.cursor.line, newCursor.line);
					if (_v4) {
						return $jxxcarlson$elm_text_editor$Editor$Update$setEditorViewportForLine(newCursor.line);
					} else {
						return $elm$core$Platform$Cmd$none;
					...
					_Utils_update(
						state,
						{
							cursor: function () {
								...
								var _v8 = A2($jxxcarlson$elm_text_editor$Buffer$lineEnd, moveFrom.line, buffer);
								if (_v8.$ === 'Just') {
									var column = _v8.a;
				...
				return _Utils_Tuple3(
					_Utils_update(
						state,
						{
							cursor: function () {
								var moveFrom = function () {
									var _v10 = state.selection;
									if (_v10.$ === 'Just') {
										var selection = _v10.a;
										return A2($jxxcarlson$elm_text_editor$Position$order, selection, state.cursor).a;
									} else {
										return state.cursor;
									}
					...
					return A3(
						...
						_Utils_Tuple3(
							_Utils_update(
								...
								{cursor: cursor, selection: $elm$core$Maybe$Nothing}),
							buffer,
							$jxxcarlson$elm_text_editor$Editor$Update$setEditorViewportForLine(lineNumber)));
				}
			...
			case 'RemoveCharAfter':
				...
				if (_v23.$ === 'Just') {
					var selection = _v23.a;
					var _v24 = A2($jxxcarlson$elm_text_editor$Position$order, selection, state.cursor);
					var start = _v24.a;
					var end = _v24.b;
					return A3(
						$jxxcarlson$elm_text_editor$Editor$Update$recordHistory,
			...
			case 'RemoveCharBefore':
				var _v25 = state.selection;
				if (_v25.$ === 'Just') {
					var selection = _v25.a;
					var _v26 = A2($jxxcarlson$elm_text_editor$Position$order, selection, state.cursor);
					var start = _v26.a;
					var end = _v26.b;
					return A3(
						$jxxcarlson$elm_text_editor$Editor$Update$recordHistory,
			...
			case 'RemoveGroupAfter':
				var _v27 = state.selection;
				if (_v27.$ === 'Just') {
					var selection = _v27.a;
					var _v28 = A2($jxxcarlson$elm_text_editor$Position$order, selection, state.cursor);
					var start = _v28.a;
					var end = _v28.b;
					return A3(
						$jxxcarlson$elm_text_editor$Editor$Update$recordHistory,
			...
			case 'Copy':
				...
				if (_v29.$ === 'Nothing') {
					...
					return A3(
						...
						buffer,
						function () {
							var _v30 = A2($jxxcarlson$elm_text_editor$Position$order, sel, state.cursor);
							var start = _v30.a;
							var end = _v30.b;
							var selectedText = A3($jxxcarlson$elm_text_editor$Buffer$between, start, end, buffer);
							return _Utils_Tuple3(
			...
			case 'Cut':
				...
				if (_v31.$ === 'Nothing') {
					...
					return A3(
						...
						buffer,
						function () {
							var _v32 = A2($jxxcarlson$elm_text_editor$Position$order, sel, state.cursor);
							var start = _v32.a;
							var end = _v32.b;
							var selectedText = A3($jxxcarlson$elm_text_editor$Buffer$between, start, end, buffer);
							return _Utils_Tuple3(
			...
			case 'RemoveGroupBefore':
				var _v33 = state.selection;
				if (_v33.$ === 'Just') {
					var selection = _v33.a;
					var _v34 = A2($jxxcarlson$elm_text_editor$Position$order, selection, state.cursor);
					var start = _v34.a;
					var end = _v34.b;
					return A3(
						$jxxcarlson$elm_text_editor$Editor$Update$recordHistory,
			...
			case 'Indent':
				var _v35 = state.selection;
				if (_v35.$ === 'Just') {
					var selection = _v35.a;
					return A3(
						$jxxcarlson$elm_text_editor$Editor$Update$recordHistory,
						state,
						buffer,
					...
					var _v36 = A2($jxxcarlson$elm_text_editor$Buffer$indentFrom, state.cursor, buffer);
					var indentedBuffer = _v36.a;
					var indentedColumn = _v36.b;
					return A3(
						$jxxcarlson$elm_text_editor$Editor$Update$recordHistory,
						state,
						buffer,
			...
			case 'Deindent':
				var _v37 = state.selection;
				if (_v37.$ === 'Just') {
					var selection = _v37.a;
					var _v38 = A3($jxxcarlson$elm_text_editor$Buffer$deindentBetween, state.cursor, selection, buffer);
					var deindentedBuffer = _v38.a;
					var cursorColumn = _v38.b;
					var selectionColumn = _v38.c;
					return A3(
						$jxxcarlson$elm_text_editor$Editor$Update$recordHistory,
						state,
						buffer,
					...
					var _v39 = A2($jxxcarlson$elm_text_editor$Buffer$deindentFrom, state.cursor, buffer);
					var deindentedBuffer = _v39.a;
					var deindentedColumn = _v39.b;
					return A3(
						$jxxcarlson$elm_text_editor$Editor$Update$recordHistory,
						state,
						buffer,
			...
			case 'SelectAll':
				return _Utils_Tuple3(
					...
					buffer,
					$jxxcarlson$elm_text_editor$Editor$Update$setEditorViewportForLine(0));
			case 'SelectGroup':
			...
			case 'SelectLine':
				return _Utils_Tuple3(
					...
					$elm$core$Platform$Cmd$none);
			case 'SendLine':
				var y = A2($elm$core$Basics$max, 0, 16.0 * (state.cursor.line - 0));
				var newCursor = A2($jxxcarlson$elm_text_editor$Position$setColumn, 0, state.cursor);
				var selection = function () {
					var _v42 = A2($jxxcarlson$elm_text_editor$Buffer$lineEnd, newCursor.line, buffer);
					if (_v42.$ === 'Just') {
						var n = _v42.a;
						return $elm$core$Maybe$Just(
				...
				return _Utils_Tuple3(
					...
					buffer,
					$jxxcarlson$elm_text_editor$Editor$Update$jumpToHeight(y));
			case 'Undo':
				var _v43 = A2(
				...
				if (_v43.$ === 'Just') {
					...
					return _Utils_Tuple3(
						...
						snapshot.buffer,
						$jxxcarlson$elm_text_editor$Editor$Update$setEditorViewportForLine(snapshot.cursor.line));
				} else {
					return _Utils_Tuple3(state, buffer, $elm$core$Platform$Cmd$none);
				}
			case 'Redo':
			...
			case 'WrapAll':
				return A3(
					...
					_Utils_Tuple3(
						...
						$elm$core$Platform$Cmd$none));
			case 'WrapSelection':
				var _v47 = state.selection;
				if (_v47.$ === 'Nothing') {
					return _Utils_Tuple3(state, buffer, $elm$core$Platform$Cmd$none);
				} else {
					var sel = _v47.a;
					var _v48 = A2($jxxcarlson$elm_text_editor$Position$order, sel, state.cursor);
					var start = _v48.a;
					var end = _v48.b;
					var selectedText = A3($jxxcarlson$elm_text_editor$Buffer$between, start, end, buffer);
					var newState = _Utils_update(
					...
					var wrappedText = A2($jxxcarlson$elm_text_editor$Editor$Wrap$paragraphs, state.config, selectedText);
			...
			case 'ToggleHelp':
				if (state.showHelp) {
					var _v49 = A3($jxxcarlson$elm_text_editor$Editor$Update$load, state.config.wrapOption, $jxxcarlson$elm_text_editor$Editor$Strings$help, state);
					var newState = _v49.a;
					var newBuffer = _v49.b;
					return _Utils_Tuple3(
						_Utils_update(
							newState,
			...
			case 'ToggleSearchPanel':
				return state.showSearchPanel ? _Utils_Tuple3(
					_Utils_update(
						...
						{showSearchPanel: false}),
					buffer,
					$jxxcarlson$elm_text_editor$Editor$Update$blur('search-box')) : _Utils_Tuple3(
					_Utils_update(
						state,
						{showSearchPanel: true}),
					buffer,
					$jxxcarlson$elm_text_editor$Editor$Update$focus('search-box'));
		...
		switch (msg.$) {
			...
			case 'GetSpeech':
				return A3(
					...
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$Gettysburg}));
			case 'GetLongLongLines':
				return A3(
					$author$project$DemoSimple$load,
					...
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$LongLines}));
			case 'Reset':
				return A3(
					$author$project$DemoSimple$load,
					$jxxcarlson$elm_text_editor$Editor$Config$DontWrap,
...
var $jxxcarlson$elm_text_editor$Editor$Styles$getStyleParams = function (c) {
	return {
		...
		fontSize: $elm$core$String$fromFloat(0.8 * c.lineHeight),
		lineHeight: $elm$core$String$fromFloat(c.lineHeight),
		sliderXOffset: $elm$core$String$fromFloat(c.editorWidth + 50),
		sliderYOffset: $elm$core$String$fromFloat(((1.04348 * c.editorHeight) - 90.87) - 20)
	};
};
...
var $jxxcarlson$elm_text_editor$Editor$Styles$styleText = function (styleConfig) {
	...
	return A2(
		...
		_List_fromArray(
			[s.editorWidth, s.sliderXOffset, s.fontSize, s.lineHeight, s.sliderYOffset, s.sliderXOffset, s.editorHeight]));
};
	...
	controlAndOption: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				_Utils_Tuple2('w', $jxxcarlson$elm_text_editor$Editor$Update$ToggleWrapping),
				_Utils_Tuple2('C', $jxxcarlson$elm_text_editor$Editor$Update$Clear)
			])),
...
var $jxxcarlson$elm_text_editor$Editor$View$goToLinePanel_ = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[$jxxcarlson$elm_text_editor$Editor$View$goToLineButton, $jxxcarlson$elm_text_editor$Editor$View$acceptLineNumber]));
var $jxxcarlson$elm_text_editor$Editor$View$goToLinePanel = function (state) {
	return state.showGoToLinePanel ? $jxxcarlson$elm_text_editor$Editor$View$goToLinePanel_ : A2($elm$html$Html$div, _List_Nil, _List_Nil);
};
...
var $jxxcarlson$elm_text_editor$Editor$View$gutter = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $jxxcarlson$elm_text_editor$Editor$View$currentLineLength = F2(
	function (state, lines) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Length: ' + lineLength)
				]));
	});
var $jxxcarlson$elm_text_editor$Editor$Widget$columnButtonStyle = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'margin-top', '10px'),
		A2($elm$html$Html$Attributes$style, 'font-size', '12px'),
		A2($elm$html$Html$Attributes$style, 'border', 'none'),
...
var $jxxcarlson$elm_text_editor$Editor$View$cursorPosition = function (state) {
	return A2(
		$elm$html$Html$div,
		$jxxcarlson$elm_text_editor$Editor$Widget$columnButtonStyle,
		_List_fromArray(
			[
				$elm$html$Html$text(
				'Cursor = (' + ($elm$core$String$fromInt(state.cursor.line + 1) + (', ' + ($elm$core$String$fromInt(state.cursor.column) + ')'))))
			]));
};
...
var $jxxcarlson$elm_text_editor$Editor$Widget$lightColumnButton = F4(
	function (width, msg, str, attr) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap($jxxcarlson$elm_text_editor$Editor$Widget$columnButtonStyle, attr),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$button,
...
var $jxxcarlson$elm_text_editor$Editor$View$dismissInfoPanel = A4($jxxcarlson$elm_text_editor$Editor$Widget$lightColumnButton, 20, $jxxcarlson$elm_text_editor$Editor$Update$ToggleInfoPanel, 'X', _List_Nil);
var $elm$core$Basics$round = _Basics_round;
var $jxxcarlson$elm_text_editor$Editor$View$roundTo = F2(
	function (places, x) {
		var pp = places;
		var factor = A2($elm$core$Basics$pow, 10, pp);
		return function (u) {
			return u / factor;
		}(
			$elm$core$Basics$round(x * factor));
	});
var $jxxcarlson$elm_text_editor$Editor$View$displayLineHeight = F2(
	function (state, lines) {
		var h = state.config.lineHeight * state.cursor.line;
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					'Height: ' + $elm$core$String$fromFloat(
						A2($jxxcarlson$elm_text_editor$Editor$View$roundTo, 2, h)))
				]));
	});
var $jxxcarlson$elm_text_editor$Editor$Style$lightBlue = '#ebeffa';
var $jxxcarlson$elm_text_editor$Editor$View$infoPanelStyle = _List_fromArray(
	[
		...
		A2($elm$html$Html$Attributes$style, 'background-color', $jxxcarlson$elm_text_editor$Editor$Style$lightBlue),
...
var $jxxcarlson$elm_text_editor$Editor$Widget$buttonLabelStyle = function (width) {
	return _List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'font-size', '12px'),
			A2($elm$html$Html$Attributes$style, 'background-color', '#666'),
...
var $jxxcarlson$elm_text_editor$Editor$Widget$columnButton = F4(
	function (width, msg, str, attr) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap($jxxcarlson$elm_text_editor$Editor$Widget$columnButtonStyle, attr),
			_List_fromArray(
				[
					...
					_Utils_ap(
						...
						$jxxcarlson$elm_text_editor$Editor$Widget$buttonLabelStyle(width)),
					_List_fromArray(
						[
							$elm$html$Html$text(str)
						]))
...
var $jxxcarlson$elm_text_editor$Editor$View$toggleHelpButton = function (state) {
	var label = state.showHelp ? 'Help' : 'Back';
	return A4($jxxcarlson$elm_text_editor$Editor$Widget$columnButton, 80, $jxxcarlson$elm_text_editor$Editor$Update$ToggleHelp, label, _List_Nil);
};
...
var $jxxcarlson$elm_text_editor$Editor$View$wrappingOption = function (state) {
...
var $jxxcarlson$elm_text_editor$Editor$View$infoPanel_ = F2(
	function (state, lines) {
		return A2(
			$elm$html$Html$div,
			$jxxcarlson$elm_text_editor$Editor$View$infoPanelStyle,
			_List_fromArray(
				[
					$jxxcarlson$elm_text_editor$Editor$View$toggleHelpButton(state),
					$jxxcarlson$elm_text_editor$Editor$View$cursorPosition(state),
					A2($jxxcarlson$elm_text_editor$Editor$View$currentLineLength, state, lines),
					A2($jxxcarlson$elm_text_editor$Editor$View$displayLineHeight, state, lines),
					$jxxcarlson$elm_text_editor$Editor$View$lineCount(lines),
					$jxxcarlson$elm_text_editor$Editor$View$wordCount(lines),
					$jxxcarlson$elm_text_editor$Editor$View$wrappingOption(state),
					$jxxcarlson$elm_text_editor$Editor$View$dismissInfoPanel
				]));
	});
var $jxxcarlson$elm_text_editor$Editor$View$infoPanel = F2(
	function (state, lines) {
		return state.showInfoPanel ? A2($jxxcarlson$elm_text_editor$Editor$View$infoPanel_, state, lines) : A2($elm$html$Html$div, _List_Nil, _List_Nil);
	});
...
var $jxxcarlson$elm_text_editor$Editor$View$acceptSearchText = A5(
	...
	_List_fromArray(
		[
			$jxxcarlson$elm_text_editor$Editor$View$setHtmlId('search-box')
		]));
...
var $jxxcarlson$elm_text_editor$Editor$View$dismissSearchPanel = A4($jxxcarlson$elm_text_editor$Editor$Widget$lightRowButton, 25, $jxxcarlson$elm_text_editor$Editor$Update$ToggleSearchPanel, 'X', _List_Nil);
...
var $jxxcarlson$elm_text_editor$Editor$View$numberOfHitsDisplay = function (state) {
	...
	return A4($jxxcarlson$elm_text_editor$Editor$Widget$rowButton, 40, $jxxcarlson$elm_text_editor$Editor$Update$NoOp, n, _List_Nil);
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($jxxcarlson$elm_text_editor$Editor$View$infoPanel, state, lines),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
...
var $jxxcarlson$elm_text_editor$Editor$embedded = F2(
	function (editorConfig, editor) {
		var styleConfig = {editorHeight: editorConfig.height, editorWidth: editorConfig.width, lineHeight: editorConfig.lineHeight};
		var height_ = editorConfig.height;
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
...
var $author$project$DemoSimple$GetLongLongLines = {$: 'GetLongLongLines'};
...
var $author$project$DemoSimple$rowButton = F4(
	function (width, msg, str, attr) {
		return A2(
			$elm$html$Html$div,
...
var $author$project$DemoSimple$longLinesTextButton = A4($author$project$DemoSimple$rowButton, 160, $author$project$DemoSimple$GetLongLongLines, 'Long lines', _List_Nil);
var $author$project$DemoSimple$Reset = {$: 'Reset'};
var $author$project$DemoSimple$resetButton = A4($author$project$DemoSimple$rowButton, 80, $author$project$DemoSimple$Reset, 'Reset', _List_Nil);
var $author$project$DemoSimple$GetSpeech = {$: 'GetSpeech'};
var $author$project$DemoSimple$speechTextButton = A4($author$project$DemoSimple$rowButton, 160, $author$project$DemoSimple$GetSpeech, 'Gettysburg Address', _List_Nil);
var $author$project$DemoSimple$FindTreasure = {$: 'FindTreasure'};
var $author$project$DemoSimple$treasureButton = function (model) {
	var _v0 = model.document;
	if (_v0.$ === 'Jabberwock') {
		return A4($author$project$DemoSimple$rowButton, 120, $author$project$DemoSimple$FindTreasure, 'Find treasure', _List_Nil);
	} else {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$DemoSimple$resetButton,
						$author$project$DemoSimple$treasureButton(model),
						$author$project$DemoSimple$speechTextButton,
						$author$project$DemoSimple$longLinesTextButton
					]))
			]));
};
